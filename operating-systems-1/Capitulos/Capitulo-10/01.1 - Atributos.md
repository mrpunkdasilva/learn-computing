...
## Fluxo
Em exemplo, uma entrada do diretório consiste no nome do **arquivo e o seu identificador exclusivo** . O **identificador** **busca os outros atributos**, assim os arquivos são trazidos aos poucos para a memoria conforme o necessário.